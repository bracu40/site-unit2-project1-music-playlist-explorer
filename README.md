...
**Walkthrough video:** [Music Playlist Explorer Walkthrough](https://www.loom.com/share/830a1ddfe8804251a9642f17c83d3413)

### Reflection

* Did the topics discussed in your labs prepare you to complete the assignment? Be specific, which features in your weekly assignment did you feel unprepared to complete?

Yes, the labs helped with developing my skills of utilizing APIs in my program.

* If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.
  
I would have improved the visual design of the website, made it look cleaner. I would also implement the play song element in the features page as I did in the all page.

* Reflect on your project demo, what went well? Were there things that maybe didn't go as planned? Did you notice something that your peer did that you would like to try next time?

What went well was that I felt proud to present my work. I didn't plan on omitting certain features that I implemented, because I forgot to. I was a fan of the favorites playlist that a user can add to by liking a song.
...
Shout out to Charles and Prateek for answering clarifying questions I had along the way.
